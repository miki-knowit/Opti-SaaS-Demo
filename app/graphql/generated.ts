...
export type FooterLinksGeneralBlock = IData &
    _IComponent &
    _IContent &
    _IItem & {
...
export type FooterSocials = IData &
    _IComponent &
    _IContent &
    _IItem & {
...
export type FooterTextGeneralBlock = IData &
    _IComponent &
    _IContent &
    _IItem & {
...
export type SectionBlock = IData &
    _IComponent &
    _IContent &
    _IItem & {
...
export type TextImageBlock = IData &
    _IComponent &
    _IContent &
    _IItem & {
...
export type FooterBlockQuery = {
    __typename?: 'Query';
    FooterBlock?: {
        __typename?: 'FooterBlockOutput';
        items?: Array<{
            __typename?: 'FooterBlock';
            SocialsHeader?: string | null;
            ContentAreaGeneral?: Array<
                | { __typename: 'BlankExperience' }
                | { __typename: 'BlankSection' }
                | { __typename: 'CommonPage' }
                | { __typename: 'FooterBlock' }
                | {
                      __typename: 'FooterLinksGeneralBlock';
                      LinkListHeader?: string | null;
                      TextField?: string | null;
                      LinkList?: Array<{
                          __typename?: 'Link';
                          text?: string | null;
                          title?: string | null;
                          url?: { __typename?: 'ContentUrl'; default?: string | null } | null;
                      } | null> | null;
                  }
                | { __typename: 'FooterSocials' }
                | {
                      __typename: 'FooterTextGeneralBlock';
                      TextListHeader?: string | null;
                      ContentAreaForTextRows?: Array<
                          | { __typename: 'BlankExperience' }
                          | { __typename: 'BlankSection' }
                          | { __typename: 'CommonPage' }
                          | { __typename: 'FooterBlock' }
            ...
            ContentAreaForSocials?: Array<
                ...
                | {
                      ...
                      Link?: { __typename?: 'ContentUrl'; default?: string | null } | null;
                  }
                | { __typename: 'FooterTextGeneralBlock' }
                | { __typename: 'GenericMedia' }
                | { __typename: 'HeaderBlock' }
    ...
    StartPage?: {
        ...
        items?: Array<{
            ...
            ContentAreaProp?: Array<
                ...
                | {
                      __typename: 'TextBlock';
                      TextProp?: { __typename?: 'RichText'; html?: string | null } | null;
                  }
                | { __typename: 'TextImageBlock' }
                | { __typename: 'TextRow' }
                | { __typename: 'VideoMedia' }
...
export const FooterBlockDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'FooterBlock' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                            ...
                            selections: [
                                {
                                    ...
                                    selectionSet: {
                                        ...
                                        selections: [
                                            {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'SocialsHeader' },
                                            },
                                            {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'ContentAreaGeneral' },
                                                selectionSet: {
                                                    kind: 'SelectionSet',
                                                    selections: [
                                                        {
...
} as unknown as DocumentNode<FooterBlockQuery, FooterBlockQueryVariables>;
export const HeaderBlockDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
...
} as unknown as DocumentNode<HeaderBlockQuery, HeaderBlockQueryVariables>;
export const StartPageDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
                            ...
                            selections: [
                                {
                                    ...
                                    selectionSet: {
                                        ...
                                        selections: [
                                            ...
                                            {
                                                kind: 'Field',
                                                name: { kind: 'Name', value: 'ContentAreaProp' },
                                                selectionSet: {
                                                    kind: 'SelectionSet',
                                                    selections: [
                                                        {
...
} as unknown as DocumentNode<StartPageQuery, StartPageQueryVariables>;
