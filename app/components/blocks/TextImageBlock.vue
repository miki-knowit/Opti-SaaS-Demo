...
<template>
  <article class="section__item image-and-text-block">
    <div class="image-and-text-block__content">
      <div class="image-and-text-block__column image-and-text-block__column--half image-and-text-block__image-block">
        <img
      ...
      <div class="image-and-text-block__column image-and-text-block__column--half">
        ...
        <div v-if="block.TextBlock?.TextProp?.html" v-html="block.TextBlock.TextProp.html" />
      </div>
    </div>
  </article>
</template>
